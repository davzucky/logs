...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT AssemblyCodebase_full_name_path_size = (PAL_wcslen(AssemblyCodebase) + 1)*sizeof(WCHAR);
    ...
    INT AssemblyName_full_name_path_size = (PAL_wcslen(AssemblyName) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT ILImage_full_name_path_size = (PAL_wcslen(ILImage) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT Module_full_name_path_size = (PAL_wcslen(Module) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT Type_full_name_path_size = (PAL_wcslen(Type) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT Method_full_name_path_size = (PAL_wcslen(Method) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT Field_full_name_path_size = (PAL_wcslen(Field) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT FailFastUserMessage_full_name_path_size = (PAL_wcslen(FailFastUserMessage) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT Operation_full_name_path_size = (PAL_wcslen(Operation) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT Message_full_name_path_size = (PAL_wcslen(Message) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT String1_full_name_path_size = (PAL_wcslen(String1) + 1)*sizeof(WCHAR);
    ...
    INT String2_full_name_path_size = (PAL_wcslen(String2) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT SecondTypeName_full_name_path_size = (PAL_wcslen(SecondTypeName) + 1)*sizeof(WCHAR);
...
)
{
  ULONG Error = ERROR_WRITE_FAULT;
    ...
    INT InterfaceTypeName_full_name_path_size = (PAL_wcslen(InterfaceTypeName) + 1)*sizeof(WCHAR);
    ...
    INT VariantInterfaceTypeName_full_name_path_size = (PAL_wcslen(VariantInterfaceTypeName) + 1)*sizeof(WCHAR);
