...
TRACEPOINT_EVENT_CLASS(
    ...
    GCBulkRootCCW_TRACEPOINT_ARGS,
     TP_FIELDS(
        ctf_integer(unsigned int, Count, Count)
        ctf_integer(unsigned short, ClrInstanceID, ClrInstanceID)
        ctf_integer(ULONG, Arg0_Struct_Len_, Arg0_Struct_Len_)
        ctf_sequence(int, Arg0_Struct_Pointer_, Arg0_Struct_Pointer_,size_t,Count*Arg0_Struct_Len_/sizeof(int))
    )
)
